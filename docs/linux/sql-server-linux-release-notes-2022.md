...
This section lists the latest versions of each package per distribution, for [!INCLUDE [ssSQL22](../includes/sssql22-md.md)]. The following table shows the most recent release, which is **CU 20 GDR 2**. For full release history, see [Release history for SQL Server 2022 on Linux](/troubleshoot/sql/releases/linux/release-history-2022).

| Version | Release | Date | Build | KB article |
| --- | --- | --- | --- | --- |
| [!INCLUDE [ssSQL22](../includes/sssql22-md.md)] | CU 20 GDR 2 | 2025-09-09 | 16.0.4212.1 | [KB 5065220](https://support.microsoft.com/help/5065220) |
...
| RHEL 9 | Database Engine | 16.0.4212.1-3 | [Database Engine RPM package](https://packages.microsoft.com/rhel/9/mssql-server-2022/Packages/m/mssql-server-16.0.4212.1-3.x86_64.rpm) |
| RHEL 9 | Extensibility | 16.0.4212.1-3 | [Extensibility RPM package](https://packages.microsoft.com/rhel/9/mssql-server-2022/Packages/m/mssql-server-extensibility-16.0.4212.1-3.x86_64.rpm) |
| RHEL 9 | Full-Text Search | 16.0.4212.1-3 | [Full-Text Search RPM package](https://packages.microsoft.com/rhel/9/mssql-server-2022/Packages/m/mssql-server-fts-16.0.4212.1-3.x86_64.rpm) |
| RHEL 9 | High Availability | 16.0.4212.1-3 | [High Availability RPM package](https://packages.microsoft.com/rhel/9/mssql-server-2022/Packages/m/mssql-server-ha-16.0.4212.1-3.x86_64.rpm) |
| RHEL 9 | PolyBase | 16.0.4212.1-3 | [PolyBase RPM package](https://packages.microsoft.com/rhel/9/mssql-server-2022/Packages/m/mssql-server-polybase-16.0.4212.1-3.x86_64.rpm) |
...
| SLES 15 | Database Engine | 16.0.4212.1-3 | [Database Engine RPM package](https://packages.microsoft.com/sles/15/mssql-server-2022/Packages/m/mssql-server-16.0.4212.1-3.x86_64.rpm) |
| SLES 15 | Extensibility | 16.0.4212.1-3 | [Extensibility RPM package](https://packages.microsoft.com/sles/15/mssql-server-2022/Packages/m/mssql-server-extensibility-16.0.4212.1-3.x86_64.rpm) |
| SLES 15 | Full-Text Search | 16.0.4212.1-3 | [Full-Text Search RPM package](https://packages.microsoft.com/sles/15/mssql-server-2022/Packages/m/mssql-server-fts-16.0.4212.1-3.x86_64.rpm) |
| SLES 15 | High Availability | 16.0.4212.1-3 | [High Availability RPM package](https://packages.microsoft.com/sles/15/mssql-server-2022/Packages/m/mssql-server-ha-16.0.4212.1-3.x86_64.rpm) |
| SLES 15 | PolyBase | 16.0.4212.1-3 | [PolyBase RPM package](https://packages.microsoft.com/sles/15/mssql-server-2022/Packages/m/mssql-server-polybase-16.0.4212.1-3.x86_64.rpm) |
| **Ubuntu** | | | |
| Ubuntu 22.04 | Database Engine | 16.0.4212.1-3 | [Database Engine Debian package](https://packages.microsoft.com/ubuntu/22.04/mssql-server-2022/pool/main/m/mssql-server/mssql-server_16.0.4212.1-3_amd64.deb) |
| Ubuntu 22.04 | Extensibility | 16.0.4212.1-3 | [Extensibility Debian package](https://packages.microsoft.com/ubuntu/22.04/mssql-server-2022/pool/main/m/mssql-server-extensibility/mssql-server-extensibility_16.0.4212.1-3_amd64.deb) |
| Ubuntu 22.04 | Full-Text Search | 16.0.4212.1-3 | [Full-Text Search Debian package](https://packages.microsoft.com/ubuntu/22.04/mssql-server-2022/pool/main/m/mssql-server-fts/mssql-server-fts_16.0.4212.1-3_amd64.deb) |
| Ubuntu 22.04 | High Availability | 16.0.4212.1-3 | [High Availability Debian package](https://packages.microsoft.com/ubuntu/22.04/mssql-server-2022/pool/main/m/mssql-server-ha/mssql-server-ha_16.0.4212.1-3_amd64.deb) |
| Ubuntu 22.04 | PolyBase | 16.0.4212.1-3 | [PolyBase Debian package](https://packages.microsoft.com/ubuntu/22.04/mssql-server-2022/pool/main/m/mssql-server-polybase/mssql-server-polybase_16.0.4212.1-3_amd64.deb) |
