...
This section lists the latest versions of each package per distribution, for [!INCLUDE [ssSQL25](../includes/sssql25-md.md)]. The following table shows the most recent release, which is **CU 2**. For full release history, see [Release history for SQL Server 2025 on Linux](/troubleshoot/sql/releases/linux/release-history-2025).

| Version | Release | Date | Build | KB article |
| --- | --- | --- | --- | --- |
| [!INCLUDE [ssSQL25](../includes/sssql25-md.md)] | CU 2 | 2026-02-12 | 17.0.4015.4 | [Support article](/troubleshoot/sql/releases/sqlserver-2025/cumulativeupdate2) |

| Distribution | Package name | Package version | Download |
| --- | --- | --- | --- |
| **Red Hat Enterprise Linux** | | | |
| RHEL 10 | Database Engine | 17.0.4015.4-11 | [Database Engine RPM package](https://packages.microsoft.com/rhel/10/mssql-server-2025/Packages/m/mssql-server-17.0.4015.4-11.x86_64.rpm) |
| RHEL 10 | Extensibility | 17.0.4015.4-11 | [Extensibility RPM package](https://packages.microsoft.com/rhel/10/mssql-server-2025/Packages/m/mssql-server-extensibility-17.0.4015.4-11.x86_64.rpm) |
| RHEL 10 | Full-Text Search | 17.0.4015.4-11 | [Full-Text Search RPM package](https://packages.microsoft.com/rhel/10/mssql-server-2025/Packages/m/mssql-server-fts-17.0.4015.4-11.x86_64.rpm) |
| RHEL 10 | High Availability | 17.0.4015.4-11 | [High Availability RPM package](https://packages.microsoft.com/rhel/10/mssql-server-2025/Packages/m/mssql-server-ha-17.0.4015.4-11.x86_64.rpm) |
| RHEL 10 | PolyBase | 17.0.4015.4-11 | [PolyBase RPM package](https://packages.microsoft.com/rhel/10/mssql-server-2025/Packages/m/mssql-server-polybase-17.0.4015.4-11.x86_64.rpm) |
| **Ubuntu** | | | |
| Ubuntu 24.04 | Database Engine | 17.0.4015.4-11 | [Database Engine Debian package](https://packages.microsoft.com/ubuntu/24.04/mssql-server-2025/pool/main/m/mssql-server/mssql-server_17.0.4015.4-11_amd64.deb) |
| Ubuntu 24.04 | Extensibility | 17.0.4015.4-11 | [Extensibility Debian package](https://packages.microsoft.com/ubuntu/24.04/mssql-server-2025/pool/main/m/mssql-server-extensibility/mssql-server-extensibility_17.0.4015.4-11_amd64.deb) |
| Ubuntu 24.04 | Full-Text Search | 17.0.4015.4-11 | [Full-Text Search Debian package](https://packages.microsoft.com/ubuntu/24.04/mssql-server-2025/pool/main/m/mssql-server-fts/mssql-server-fts_17.0.4015.4-11_amd64.deb) |
| Ubuntu 24.04 | High Availability | 17.0.4015.4-11 | [High Availability Debian package](https://packages.microsoft.com/ubuntu/24.04/mssql-server-2025/pool/main/m/mssql-server-ha/mssql-server-ha_17.0.4015.4-11_amd64.deb) |
| Ubuntu 24.04 | PolyBase | 17.0.4015.4-11 | [PolyBase Debian package](https://packages.microsoft.com/ubuntu/24.04/mssql-server-2025/pool/main/m/mssql-server-polybase/mssql-server-polybase_17.0.4015.4-11_amd64.deb) |
