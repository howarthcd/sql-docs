...
To work around this issue, enable AVX2 CPU instructions on the machine. AVX instructions might be disabled in the machine BIOS or UEFI, or disabled in the hypervisor configuration.
