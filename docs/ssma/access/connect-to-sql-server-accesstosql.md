---
title: "Connect to SQL Server (GUI) (AccessToSQL)"
...
---
# Connect to SQL Server (GUI) (AccessToSQL)
...
If you want to securely connect to SQL Server, you can encrypt your connection by checking the **Encrypt connection** checkbox.
