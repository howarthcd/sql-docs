...
An [expression](../language-elements/expressions-transact-sql.md) of type **char** or **varchar**.
...
ASCII stands for **A**merican **S**tandard **C**ode for **I**nformation **I**nterchange. It serves as a character encoding standard for modern computers. See the **Printable characters** section of [ASCII](https://en.wikipedia.org/wiki/ASCII) for a list of ASCII characters.
