...
> [!TIP]  
> If you're unfamiliar with the MSSQL extension for Visual Studio Code, get a comprehensive overview of its features and capabilities in [What is the MSSQL extension for Visual Studio Code?](../mssql/mssql-extension-visual-studio-code.md)
...
1. Once you're signed in, GitHub Copilot is active and ready to assist as you write code in your editor.
